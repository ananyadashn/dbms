...
CREATE TABLE `Crime` (
  ...
  `Criminal_Aadhar_Number` varchar(30) NOT NULL,
  PRIMARY KEY (`Complaint_ID`,`Criminal_Aadhar_Number`),
  KEY `fk_Crime_1_idx` (`Criminal_Aadhar_Number`),
  CONSTRAINT `fk_Crime_1` FOREIGN KEY (`Criminal_Aadhar_Number`) REFERENCES `Citizen` (`Aadhar_Number`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Crime_2` FOREIGN KEY (`Complaint_ID`) REFERENCES `Complaint` (`Complaint_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Crime` VALUES (12236,'1234 5678 4454'),(12242,'2134 5678 4454'),(12237,'6372 5161 2847'),(12240,'6632 1761 8823'),(12241,'7341 9901 1000'),(12235,'7341 9901 1108'),(12243,'7362 5161 2847'),(12239,'8192 7176 7182');
...
-- Dump completed on 2019-11-08 11:29:14
